...
<head>
    ...
    <link rel="stylesheet" href="assets/css/edit_anggota.css">
</head>
<body>
    <div class="container">
        <h1>Edit Anggota</h1>
        <form id="memberEditForm" class="pure-form" onsubmit="return validateEditForm()">
    ...
    <script>
        function validateEditForm() {
            ...
            alert('Perubahan anggota berhasil disimpan!');
            return true;
        }
    </script>
<?php
